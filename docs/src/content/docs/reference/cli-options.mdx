...
`dmd profile fields` lists supported stored field names, expected value types, and whether `none` is allowed.
...
- `dmd profile add nightly-dms --set include_ids='["123456789012345678"]'`
